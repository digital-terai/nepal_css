      ...
      <v-layout row wrap>
        <v-flex lg12 sm12 xs12>
          <v-widget title="Projects Detail" content-bg="white">
            ...
            <v-btn icon slot="widget-header-action" to="/admin/projects/hydro">
                            ...
                            <v-card-text>
                              <v-form v-model="valid" ref="form" lazy-validation>
                                <v-layout row wrap>
                                  ...
                                  <v-flex lg12 sm12>
                                    <v-select :items="type" label="Document Type"></v-select>
                                  </v-flex>
                                  <v-flex lg12 sm12>
                                    <v-menu
                                      ref="menu"
                            ...
                            <v-card-text>
                              <v-form v-model="valid" ref="form" lazy-validation>
                                <v-layout row wrap>
                                  ...
                                  <v-flex lg12 sm12>
                                    <v-select :items="type" label="License Type"></v-select>
                                  </v-flex>
                                  <v-flex lg12 sm12>
                                    <v-menu
                                      ref="menu"
                          ...
                          <v-card>
                            <v-card-text>
                              <v-form v-model="valid" ref="form" lazy-validation>
                                <v-layout row wrap>
                                  <v-flex lg6 sm6>
                                    <v-select :items="dryMonths" label="Dry Month"></v-select>
                                  </v-flex>
                                  <v-flex lg5 sm6 offset-lg1>
                                    <v-select :items="wetMonths" label="Wet Month"></v-select>
                                  </v-flex>
                                  <v-flex lg6 sm6>
                                    <v-select :items="type" label="Organization"></v-select>
                                  </v-flex>
                                  <v-flex lg5 sm6 offset-lg1>
                                    <v-menu
                                      ref="menu"
                          ...
                          <v-card>
                            <v-card-text>
                              <v-form v-model="valid" ref="form" lazy-validation>
                                <v-layout row wrap>
                                  <v-flex lg12 sm12>
                                    <v-select :items="task" label="Select Task"></v-select>
                                  </v-flex>
                                  <v-flex lg12 sm12>
                                    <v-text-field label="Target Type" name="license"></v-text-field>
                                  </v-flex>
                                  <v-flex lg12 sm12>
                                    <v-text-field label="Target" name="license"></v-text-field>
                                  </v-flex>
                                  <v-flex lg12 sm12>
                                    <v-menu
                                      ref="menu"
                ...
                <v-flex lg12>
                  <v-card color="grey lighten-4" flat tile>
                    <v-toolbar dense>
                      ...
                      <v-btn icon to="/admin/projects/hydro/create">
                        <v-icon>add</v-icon>
                      </v-btn>
                    ...
                    <v-card-text>
                      <v-layout row wrap>
                        ...
                        <v-flex lg3>Sunkoshi Small Hydro Electric Project</v-flex>
                        <v-flex lg3>Latitude N1</v-flex>
                        <v-flex lg3>32.3234</v-flex>
                        <v-flex lg3>Latitude N2</v-flex>
                        <v-flex lg3>22.32323</v-flex>
                                ...
                                <template slot="items" slot-scope="props">
                                  ...
                                  <td>
                                    <v-btn
                                      ...
                                      small
                                    >{{'Active'}}</v-btn>
                                    <v-btn v-else color="error" small>{{ 'Deactive'}}</v-btn>
                                  </td>
...
export default {
  ...
  methods: {
    ...
    deletefile(id) {
      this.$refs.showmodal.deletefiles(id);
      this.showdocuments;
    },
    clear() {
      this.formModel = {};
    ...
    showdocuments: async function() {
      await this.$axios
        .$get("/showdocumentforhydro/" + this.project_id)
        .then(response => {
  ...
  mounted() {
    this.showdocuments();
    if (this.project_id) {
      this.$axios.$get("/showhydropower/" + this.project_id).then(response => {
